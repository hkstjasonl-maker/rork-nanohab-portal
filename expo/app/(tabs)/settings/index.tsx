  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Settings 設定</Text>
      </View>
      ...
      >
          ...
          <View style={styles.profileInfo}>
            ...
            <View style={styles.rolePill}>
              ...
              <Text style={styles.rolePillText}>
                {isAdmin ? 'Admin' : `Clinician (Tier: ${clinician?.tier_id || 'N/A'})`}
              </Text>
            </View>
          </View>
        </View>
          ...
          <View style={styles.sectionCard}>
            <TouchableOpacity style={styles.settingsRow} activeOpacity={0.6}>
              <View style={styles.settingsRowLeft}>
                ...
                <Text style={styles.settingsLabel}>About 關於</Text>
              </View>
        ...
        >
          ...
          <Text style={styles.logoutText}>Sign Out 登出</Text>
        </TouchableOpacity>
        ...
        <View style={styles.aboutFooter}>
          ...
          <Text style={styles.copyright}>
            © Dr. Avive Group Limited. All rights reserved.
          </Text>
