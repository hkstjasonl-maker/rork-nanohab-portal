...
import { ChevronLeft, Building } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.center}>
        <View style={styles.iconWrap}>
          <Building size={56} color={Colors.textTertiary} />
        </View>
        <Text style={styles.title}>Managing Org — Coming Soon</Text>
        <Text style={styles.subtitle}>管理機構 — 即將推出</Text>
